...
const InvoiceItemDropdown = ({ itemDropdown, refreshDropdown, handleItem }) => {
    // console.log("sInvoiceDropdown-------->", itemDropdown)
    const [type, SetType] = useState('Select Item')
    const handleItemClick = (item) => {
        handleItem(item)
        SetType(item)
    };
    return (
        <TEDropdown className="flex w-full" onClick={refreshDropdown}>
...
export default InvoiceItemDropdown;

InvoiceItemDropdown.propTypes = {
